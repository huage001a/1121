...
//项目路径，不可更改
define('APP_PATH', SITE_PATH . 'yuanddnet/');
// 模板路径
//define('TMPL_PATH', dirname(dirname(SITE_PATH)));
//项目相对路径，不可更改
define('SPAPP_PATH',   SITE_PATH.'simplewind/');
//
define('SPAPP',   './yuanddnet/');
//项目资源目录，不可更改
define('SPSTATIC',   SITE_PATH.'statics/');
//定义缓存存放路径
define("RUNTIME_PATH", SITE_PATH . "data/qyshow/");
//静态缓存目录
define("HTML_PATH", SITE_PATH . "data/qyshow/Html/");
//版本号
